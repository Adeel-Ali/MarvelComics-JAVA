...
import com.marvel.gateway.MarvelComicsClient;
import com.marvel.gateway.testing.HttpCallBackCatcher;
...
public class ControllerTestBase {
    ...
    private static MarvelComicsClient client;
     ...
     * @return
     */
    protected static MarvelComicsClient getClient() {
        if(client == null)
            synchronized (clientSync) {
                client = new MarvelComicsClient();
            }
        return client;
    }
}
