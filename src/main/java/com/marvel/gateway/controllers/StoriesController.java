...
public class StoriesController extends BaseController {    
     ...
     * @return The singleton instance of the StoriesController class 
     */
    ...
    public CharacterDataWrapper getCharacterCollectionByStoryId(
        ...
        getCharacterCollectionByStoryIdAsync(storyId, name, nameStartsWith, modifiedSince, comics, series, events, orderBy, limit, offset, callback);
     ...
     */
    public void getCharacterCollectionByStoryIdAsync(
                final String storyId,
                final String name,
                final String nameStartsWith,
                final String modifiedSince,
        ...
        APIHelper.appendUrlWithTemplateParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 5604875279838554562L;
            {
                    put( "storyId", storyId );
            }});
        ...
        APIHelper.appendUrlWithQueryParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 5538287386569237654L;
            {
                    put( "name", name );
        ...
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5151848274253479417L;
            {
     ...
     * @return    Returns the void response from the API call 
     */
    public void getComicsCollectionByStoryIdAsync(
                final String storyId,
                final String format,
                final FormatTypeEnum formatType,
                final String noVariants,
        ...
        //process template parameters
        APIHelper.appendUrlWithTemplateParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 5512503116169419327L;
            {
                    put( "storyId", storyId );
            }});
        ...
        //process query parameters
        APIHelper.appendUrlWithQueryParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 5438706381751326814L;
            {
                    put( "format", format );
        ...
        //load all headers for the outgoing API request
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5196643139241352820L;
            {
                    put( "user-agent", "APIMATIC 2.0" );
                    put( "accept", "application/json" );
                    put( "referer", Configuration.referer );
    ...
    public CreatorDataWrapper getCreatorCollectionByStoryId(
        ...
        getCreatorCollectionByStoryIdAsync(storyId, firstName, middleName, lastName, suffix, nameStartsWith, firstNameStartsWith, middleNameStartsWith, lastNameStartsWith, modifiedSince, comics, series, events, orderBy, limit, offset, callback);
        if(!callback.isSuccess())
            throw callback.getError();
        return callback.getResult();
    }
     ...
     * @return    Returns the void response from the API call 
     */
    public void getCreatorCollectionByStoryIdAsync(
                final String storyId,
                final String firstName,
                final String middleName,
                final String lastName,
        ...
        //process template parameters
        APIHelper.appendUrlWithTemplateParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 5134128400762798148L;
            {
                    put( "storyId", storyId );
            }});
        ...
        //process query parameters
        APIHelper.appendUrlWithQueryParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 4888303212562085723L;
            {
        ...
        //load all headers for the outgoing API request
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5737498434435788888L;
            {
                    put( "user-agent", "APIMATIC 2.0" );
                    put( "accept", "application/json" );
                    put( "referer", Configuration.referer );
    ...
    public EventDataWrapper getEventsCollectionByStoryId(
        ...
        getEventsCollectionByStoryIdAsync(storyId, name, nameStartsWith, modifiedSince, creators, characters, series, comics, orderBy, limit, offset, callback);
        if(!callback.isSuccess())
            throw callback.getError();
        return callback.getResult();
    }
     ...
     * @return    Returns the void response from the API call 
     */
    public void getEventsCollectionByStoryIdAsync(
                final String storyId,
                final String name,
                final String nameStartsWith,
                final String modifiedSince,
        ...
        //process template parameters
        APIHelper.appendUrlWithTemplateParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 4825658727683092250L;
            {
                    put( "storyId", storyId );
            }});
        ...
        //process query parameters
        APIHelper.appendUrlWithQueryParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 5605378407824244585L;
            {
                    put( "name", name );
                    put( "nameStartsWith", nameStartsWith );
                    put( "modifiedSince", modifiedSince );
        ...
        //load all headers for the outgoing API request
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 4853568791301764473L;
            {
                    put( "user-agent", "APIMATIC 2.0" );
                    put( "accept", "application/json" );
                    put( "referer", Configuration.referer );
    ...
    public SeriesDataWrapper getStorySeriesCollection(
        ...
        getStorySeriesCollectionAsync(storyId, events, title, titleStartsWith, startYear, modifiedSince, comics, creators, characters, seriesType, contains, orderBy, limit, offset, callback);
        if(!callback.isSuccess())
            throw callback.getError();
        return callback.getResult();
    }
     ...
     * @return    Returns the void response from the API call 
     */
    public void getStorySeriesCollectionAsync(
                final String storyId,
                final String events,
                final String title,
                final String titleStartsWith,
        ...
        //process template parameters
        APIHelper.appendUrlWithTemplateParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 5418811243674143118L;
            {
                    put( "storyId", storyId );
            }});
        ...
        //process query parameters
        APIHelper.appendUrlWithQueryParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 4677154423415531799L;
            {
                    put( "events", events );
                    put( "title", title );
                    put( "titleStartsWith", titleStartsWith );
        ...
        //load all headers for the outgoing API request
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5408267434999900375L;
            {
                    put( "user-agent", "APIMATIC 2.0" );
                    put( "accept", "application/json" );
                    put( "referer", Configuration.referer );
     ...
     * @param    storyId    Required parameter: Filter by story id.
     * @return    Returns the Story response from the API call 
     */
    public Story getStoryIndividual(
                final String storyId
    ) throws Throwable {
        APICallBackCatcher<Story> callback = new APICallBackCatcher<Story>();
        getStoryIndividualAsync(storyId, callback);
        if(!callback.isSuccess())
            throw callback.getError();
        return callback.getResult();
    }
     ...
     * @return    Returns the void response from the API call 
     */
    public void getStoryIndividualAsync(
                final String storyId,
        ...
        //process template parameters
        APIHelper.appendUrlWithTemplateParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 5732034210417491697L;
            {
                    put( "storyId", storyId );
            }});
        ...
        //process query parameters
        APIHelper.appendUrlWithQueryParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 4767593395062179008L;
            {
                    put( "apikey", Configuration.apikey );
            }});
        //validate and preprocess url
        ...
        //load all headers for the outgoing API request
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5116229711224008202L;
            {
                    put( "user-agent", "APIMATIC 2.0" );
                    put( "accept", "application/json" );
                    put( "referer", Configuration.referer );
                ...
                getClientInstance().executeAsStringAsync(_request, new APICallBack<HttpResponse>() {
                    public void onSuccess(HttpContext _context, HttpResponse _response) {
                        try {
                            ...
                            //extract result from the http response
                            String _responseBody = ((HttpStringResponse)_response).getBody();
                            Story _result = APIHelper.deserialize(_responseBody,
                                                        new TypeReference<Story>(){});
    ...
    public StoryDataWrapper getStoryCollection(
        ...
        getStoryCollectionAsync(modifiedSince, comics, series, events, creators, characters, orderBy, limit, offset, callback);
        if(!callback.isSuccess())
            throw callback.getError();
        return callback.getResult();
    }
     ...
     * @return    Returns the void response from the API call 
     */
    public void getStoryCollectionAsync(
                final String modifiedSince,
                final String comics,
                final String series,
                final String events,
        ...
        //process query parameters
        APIHelper.appendUrlWithQueryParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 5643222107084067018L;
            {
                    put( "modifiedSince", modifiedSince );
                    put( "comics", comics );
                    put( "series", series );
        ...
        //load all headers for the outgoing API request
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5213623185687410810L;
            {
                    put( "user-agent", "APIMATIC 2.0" );
                    put( "accept", "application/json" );
                    put( "referer", Configuration.referer );
